...
:pushpin:[DAG para esse ETL aqui]([Data_warehouse_nomenclatura/DAG/ETL_from_produto_to_dimproduto.py](https://github.com/RegiMaria/Data_Warehouse_nomenclatura/blob/main/DAG/ETL_from_produto_to_dimproduto.py).
